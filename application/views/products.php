...
<!--						<div class="col-md-3 md-col">-->
<!--							<div class="col-md">-->
<!--								<a href="single.php" class="compare-in"><img src="--><?php //echo base_url()?><!--images/pic.jpg" alt="" />-->
<!--								<div class="compare">-->
<!--									<span>Add to Compare</span>-->
<!--									<span>Add to Wishlist</span>-->
<!--								</div>-->
...
<!--						<div class="col-md-3 md-col">-->
<!--							<div class="col-md">-->
<!--								<a href="single.php" class="compare-in"><img src="--><?php //echo base_url()?><!--images/pic2.jpg" alt="" />-->
<!--								<div class="compare">-->
<!--									<span>Add to Compare</span>-->
<!--									<span>Add to Wishlist</span>-->
<!--								</div>-->
...
<!--						<div class="col-md-3 md-col">-->
<!--							<div class="col-md">-->
<!--								<a href="single.php" class="compare-in"><img src="--><?php //echo base_url()?><!--images/pic3.jpg" alt="" />-->
<!--								<div class="compare">-->
<!--									<span>Add to Compare</span>-->
<!--									<span>Add to Wishlist</span>-->
<!--								</div>-->
...
<!--						</div>-->
					...
					<div class=" top-products">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic4.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic5.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md ">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic6.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md ">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic7.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
					...
					<div class="top-products">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php" class="compare-in" ><img src="<?php echo base_url()?>images/pic8.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic9.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic10.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php" class="compare-in"><img src="<?php echo base_url()?>images/pic11.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div>
