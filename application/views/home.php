				...
				<div class="content-top">
					...
					<div class="content-top-in">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php"><img src="<?php echo base_url()?>images/pi.jpg" alt="" /></a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php"><img src="<?php echo base_url()?>images/pi1.jpg" alt="" />	</a>
								<div class="top-content">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php"><img src="<?php echo base_url()?>images/pi2.jpg" alt="" /></a>
								<div class="top-content">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.php"><img src="<?php echo base_url()?>images/pi3.jpg" alt="" /></a>
								<div class="top-content">
				...
				<div class="content-bottom">
					...
					<ul id="flexiselDemo2">			
						<li><div class="col-md men">
								<a href="single.php" class="compare-in "><img src="<?php echo base_url()?>images/pi4.jpg" alt="" />
						...
						<li><div class="col-md men">
								<a href="single.php" class="compare-in "><img src="<?php echo base_url()?>images/pi5.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div></a>	
						...
						<li><div class="col-md men">
								<a href="single.php" class="compare-in "><img src="<?php echo base_url()?>images/pi6.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div></a>	
						...
						<li><div class="col-md men">
								<a href="single.php" class="compare-in "><img src="<?php echo base_url()?>images/pi7.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Wishlist</span>
								</div></a>	
